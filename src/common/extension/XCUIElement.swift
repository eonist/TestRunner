...
extension XCUIElement {
     ...
     */
    func findElement(query: XCUIElementQuery, identifier: String) -> XCUIElement? {
...
//        Swift.print("elements.count:  \(elements.count)")
     ...
     */
    static func elements(element: XCUIElement) -> [XCUIElement] {
...
extension XCUIApplication {
    ...
    func filterElements(containing labels: String...) -> XCUIElementQuery {
