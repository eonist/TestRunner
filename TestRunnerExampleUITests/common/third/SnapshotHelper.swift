...
func snapshot(_ name: String, screenshot: XCUIScreenshot) {
    Snapshot.snapshot(name, screenshot: screenshot)
}
...
open class Snapshot: NSObject {
    ...
    open class func snapshot(_ name: String, timeWaitingForIdle timeout: TimeInterval = 20) {
        ...
        snapshot(name, screenshot: screenshot)
        #endif
    }
    #if os(iOS)
    //
    // Added to support storing screenshots of UIElement
    //
    public class func snapshot(_ name: String, screenshot: XCUIScreenshot) {
...
extension XCUIElementAttributes {
    ...
    private var hasWhiteListedIdentifier: Bool {
