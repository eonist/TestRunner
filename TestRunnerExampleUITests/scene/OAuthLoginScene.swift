...
class OAuthLoginScene: Scene {
    ...
    override func run() {
        ...
        sleep(2)
        skrivInnDinEPostEllerBrukernavnTextField.typeText(" ")
        sleep(2)
        ...
        sleep(2)
        webViewsQuery/*@START_MENU_TOKEN@*/.secureTextFields["Skriv inn ditt passord"]/*[[".otherElements.matching(identifier: \"TIDAL\").secureTextFields[\"Skriv inn ditt passord\"]",".secureTextFields[\"Skriv inn ditt passord\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.typeText(" ")
        sleep(2)
